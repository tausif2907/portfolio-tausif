  ...
  return (
    <section id="work" className="flex flex-col min-h-screen">
      ...
      >
        ...
        <div
          ref={previewRef}
          className="fixed -top-2/6 left-0 z-50 pointer-events-none md:block hidden opacity-0 w-[400px] bg-zinc-900/90 text-white p-6 rounded-2xl backdrop-blur-md border border-white/10 shadow-2xl"
        >
          {currentIndex !== null && (
            <>
              <h3 className="text-xl font-bold mb-3">{projects[currentIndex].name}</h3>
              <p className="text-sm leading-relaxed whitespace-pre-line text-gray-300">
